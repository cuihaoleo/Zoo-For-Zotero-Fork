...
import me.cvhc.zooforzotero.BuildConfig
import me.cvhc.zooforzotero.PreferenceManager
import me.cvhc.zooforzotero.ZoteroAPI.Model.CollectionPOJO
import me.cvhc.zooforzotero.ZoteroAPI.Model.DeletedEntriesPojo
import me.cvhc.zooforzotero.ZoteroAPI.Model.ItemJSONConverter
import me.cvhc.zooforzotero.ZoteroAPI.Model.KeyInfo
import me.cvhc.zooforzotero.ZoteroAPI.Model.Note
import me.cvhc.zooforzotero.ZoteroAPI.Model.ZoteroUploadAuthorizationPojo
...
import me.cvhc.zooforzotero.ZoteroStorage.ZoteroDB.ItemsDownloadProgress
...
class ZoteroAPI(
    ...
    val httpClient = OkHttpClient().newBuilder().apply {
        if (me.cvhc.zooforzotero.BuildConfig.DEBUG) {
