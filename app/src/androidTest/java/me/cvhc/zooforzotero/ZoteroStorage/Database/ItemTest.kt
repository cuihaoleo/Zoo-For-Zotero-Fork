package me.cvhc.zooforzotero.ZoteroStorage.Database
...
class ItemTest {
    lateinit var zoteroDatabase : me.cvhc.zooforzotero.ZoteroStorage.Database.ZoteroDatabase
    ...
    fun setUp() {
        ...
        zoteroDatabase =
            me.cvhc.zooforzotero.ZoteroStorage.Database.ZoteroDatabase(instrumentationContext)
